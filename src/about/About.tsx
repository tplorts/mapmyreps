    ...
    <section className='data-sources'>
      ...
      <ul>
        ...
        <li>
          ...
          <a href='https://github.com/topojson/us-atlas'>U.S. Atlas TopoJSON</a>
        </li>
        <li>
          <span>Cartographic data of congressional districts: </span>
          <a href='https://www.census.gov/'>The United States Census Bureau</a>
          <ul>
            <li>
              ...
              <span>
                {' '}
                on working with the cartographic data from the US Census Bureau.
              </span>
            </li>
          </ul>
        </li>
